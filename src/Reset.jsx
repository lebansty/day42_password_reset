...
try {
  let verifiction = await axios.get("https://passwordresetbackend1.herokuapp.com/token-verify",{
  headers:{
'authorization':token
  }
  ...
  setStcode(error.response.status)
    ...
    try {
      console.log(values)
  await axios.put("https://passwordresetbackend1.herokuapp.com/update",values,{
    headers:{
      'authorization':token
    }
  })
